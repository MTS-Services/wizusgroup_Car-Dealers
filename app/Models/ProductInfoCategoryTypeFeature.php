...
class ProductInfoCategoryTypeFeature extends BaseModel
{
     protected $fillable = [
        'sort_order',
        'product_info_cat_id',
    ...
    {
        return $this->belongsTo(ProductInfoCategory::class,'product_info_cat_id','id');
    }
    public function infoCategoryType(): BelongsTo
    {
        return $this->belongsTo(ProductInfoCategoryType::class,'product_info_cat_type_id','id');
    }
