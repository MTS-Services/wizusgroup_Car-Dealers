        ...
        <div class="container">
            <div
                ...
                <div class="w-full xl:w-1/2 p-10 md:p-12 flex flex-col justify-center">
                    <h2 class="text-3xl font-semibold text-center mb-6">{{ __('Access Your Seller Portal') }}</h2>
                    <form class="space-y-5" action="{{ route('seller.login.submit') }}" method="POST">
                        @csrf
                        <div>
                            <label class="input">
                    ...
                    <div>
                        ...
                        <p class="text-center text-sm mt-4">
                            {{ __('Don\'t have an account?') }} <a href="{{ route('seller.register') }}"
                                class="text-text-tertiary font-medium">
                                {{ __('Sign up') }} </a>
                        </p>
                        <p class="text-center text-sm mt-4">
                            {{ __('Login as') }} <a href="{{ route('login') }}"
