    ...
    <section class="py-6 sm:py-8 lg:py-20">
        <div class="container mx-auto">
            <div
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-5 md:gap-6 lg:gap-8 ">
                    @foreach ($containers as $container)
                        <!-- Container Card (Left Column) -->
                        <div class="2xl:col-span-6 tablet:col-span-6 sm:col-span-6  col-span-6  w-full">
                            <div
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-5 md:gap-6 lg:gap-8 ">
                    @foreach ($container_products as $product)
                        <div
                            class="bg-bg-white dark:bg-bg-dark-tertiary shadow-card dark:shadow-dark-card overflow-hidden transition-all duration-300 hover:shadow-xl group border border-border-gray dark:border-border-dark-secondary 2xl:col-span-6 tablet:col-span-6 sm:col-span-6  col-span-6  w-full">
