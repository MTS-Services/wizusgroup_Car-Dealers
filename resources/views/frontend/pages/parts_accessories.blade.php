                            ...
                            <div class="product-card bg-bg-light dark:bg-bg-dark-tertiary  w-full hover:translate-y-[-8px] hover:shadow-lg dark:hover:shadow-dark-card transition-all duration-300 ease-in-out group shadow-card rounded-lg overflow-hidden cursor-pointer flex flex-col"
                                ...
                                <div class="relative">
                                    <div class="w-full min-h-60 overflow-hidden">
                                        <img src="{{ $product->primaryImage }}" alt="Kubota ZL1-215"
                                    ...
                                    <div class="absolute z-50 bottom-[-10px] left-3 bg-bg-orange text-text-white px-3 py-1 rounded-md text-sm font-medium"
                                        id="timer-{{ $product->id }}" data-endDate="{{ $product->end_date }}"></div>
                                </div>
                                ...
                                <div class="flex flex-col flex-grow p-4">
                                    ...
                                    <p class="text-text-danger text-base lg:text-md font-bold mt-1">{{ __("US$ 4,800") }}
                                    </p>
                                    <div
