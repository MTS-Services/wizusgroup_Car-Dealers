...
@push('css')
    <style>
        ...
        .payment-option flex justify-center items-center gap-2 border border-border-dark border-opacity-20 dark:border-white dark:bg-bg-darkTertiary dark:border-opacity-30 focus:outline-primary focus:opacity-50 rounded p-2 text-sm w-full h-10 {
            @apply flex items-start gap-2 p-4 border-b border-border-dark border-opacity-20 dark:border-white dark:border-opacity-30;
        }
