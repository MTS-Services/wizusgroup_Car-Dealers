            ...
            <form method="POST" action="{{ route('site_setting.update') }}" autocomplete="off"
                ...
                <div class="card-body">
                    <div class="form-group {{ $errors->has('mail_mailer') ? ' has-danger' : '' }}">
                        ...
                        <x-feed-back-alert :datas="['errors' => $errors, 'field' => 'mail_mailer']" />
                    </div>
                    <div class="form-group {{ $errors->has('mail_host') ? ' has-danger' : '' }}">
                        ...
                        <x-feed-back-alert :datas="['errors' => $errors, 'field' => 'mail_host']" />
                    </div>
                    <div class="form-group{{ $errors->has('mail_port') ? ' has-danger' : '' }}">
                        ...
                        <x-feed-back-alert :datas="['errors' => $errors, 'field' => 'mail_port']" />
                    </div>
                    <div class="form-group {{ $errors->has('mail_username') ? ' has-danger' : '' }}">
                        ...
                        <input type="text" name="mail_username"
                            ...
                            autocomplete="off">
                        <x-feed-back-alert :datas="['errors' => $errors, 'field' => 'mail_username']" />
                    </div>
                    <div class="form-group {{ $errors->has('mail_password') ? ' has-danger' : '' }}">
                        ...
                        <x-feed-back-alert :datas="['errors' => $errors, 'field' => 'mail_password']" />
                    </div>
                    <div class="form-group {{ $errors->has('mail_encription') ? ' has-danger' : '' }}">
                        ...
                        <x-feed-back-alert :datas="['errors' => $errors, 'field' => 'mail_encription']" />
                    </div>
                    <div class="form-group {{ $errors->has('mail_from') ? ' has-danger' : '' }}">
                        ...
                        <x-feed-back-alert :datas="['errors' => $errors, 'field' => 'mail_from']" />
                    ...
                    <div class="form-group {{ $errors->has('mail_from_name') ? ' has-danger' : '' }}">
                        ...
                        <x-feed-back-alert :datas="['errors' => $errors, 'field' => 'mail_from_name']" />
                    </div>
                </div>
