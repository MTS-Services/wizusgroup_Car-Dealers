    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            <ul class="nav nav-secondary">
                ...
                {{-- Product Management --}}
                <li class="nav-item  @if ($page_slug == 'category' || $page_slug == 'subcategory' || $page_slug == 'subchildcategory' || $page_slug == 'company'|| $page_slug == 'tax_class' || $page_slug == 'brand' || $page_slug == 'model') active submenu @endif">
                    ...
                    <div class="collapse @if ($page_slug == 'category' || $page_slug == 'subcategory' || $page_slug == 'subchildcategory' || $page_slug == 'company' || $page_slug == 'tax_class' || $page_slug == 'brand' || $page_slug == 'model') show @endif" id="product_management">
                        <ul class="nav nav-collapse">
