    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            <ul class="nav nav-secondary">
                ...
                {{-- Product Management --}}
                <li class="nav-item  @if ($page_slug == 'category' || $page_slug == 'subcategory' || $page_slug == 'subchildcategory' || $page_slug == 'company' || $page_slug == 'brand' || $page_slug == 'model' || $page_slug == 'product_info_cat' || $page_slug == 'product_info_cat_type' || $page_slug == 'product-info-category-type-feature' ||  $page_slug == 'product') active submenu @endif">
                    <a data-bs-toggle="collapse" href="#product_management"
                        @if ($page_slug == 'category' || $page_slug == 'subcategory' || $page_slug == 'subchildcategory' || $page_slug == 'company' || $page_slug == 'brand' || $page_slug == 'model'|| $page_slug == 'product_info_cat'|| $page_slug == 'product_info_cat_type' || $page_slug == 'product-info-category-type-feature' ||  $page_slug == 'product') aria-expanded="true" @endif>
                        <i class="icon-people"></i>
                        <p>{{ __('Product Management') }}</p>
                        <span class="caret"></span>
                    </a>
                    <div class="collapse @if ($page_slug == 'category' || $page_slug == 'subcategory' || $page_slug == 'subchildcategory' || $page_slug == 'company' || $page_slug == 'brand' || $page_slug == 'model'|| $page_slug == 'product_info_cat'|| $page_slug == 'product_info_cat_type' || $page_slug == 'product-info-category-type-feature' ||  $page_slug == 'product') show @endif" id="product_management">
                        <ul class="nav nav-collapse">
