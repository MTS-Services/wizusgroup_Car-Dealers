...
@section('title', 'Operation Sub Area Recycle Bin')
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="cart-title">{{ __('Operation Sub Area Recycle Bin') }}</h4>
                    <div class="buttons">
    ...
    <script>
        $(document).ready(function() {
            ...
            const details = {
                ...
                displayLength: 10,
                main_route: "{{ route('setup.operation-sub-area.recycle-bin') }}",
                order_route: "{{ route('update.sort.order') }}",
                export_columns: [0, 1, 2, 3,4,5],
                model: 'OperationSubArea',
            };
