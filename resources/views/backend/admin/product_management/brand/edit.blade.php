    ...
    <div class="row">
        <div class="{{ $document ? 'col-md-8' : 'col-md-12' }}">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('pm.brand.update', encrypt($brand->id)) }}" method="POST"
                            ...
                            <select name="company_id" class="form-control" id="company_id">
                                ...
                                @foreach ($companies as $company)
                                    <option value="{{ $company->id }}"
                                        {{ $brand->company_id == $company->id ? 'selected' : '' }}>{{ $company->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('name', $brand->name) }}" id="title" name="name"
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" value="{{ old('website', $brand->website) }}" name="website"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('meta_title', $brand->meta_title) }}" id="meta_title" name="meta_title"
