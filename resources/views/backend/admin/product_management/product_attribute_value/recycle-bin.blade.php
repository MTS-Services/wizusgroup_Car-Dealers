...
@section('title', 'Product Attribute Value Recycle Bin')
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="cart-title">{{ __('Product Attribute Value Recycle Bin') }}</h4>
                    <div class="buttons">
    ...
    <script>
        $(document).ready(function() {
            ...
            const details = {
                ...
                displayLength: 10,
                main_route: "{{ route('pm.product-attr-value.recycle-bin') }}",
