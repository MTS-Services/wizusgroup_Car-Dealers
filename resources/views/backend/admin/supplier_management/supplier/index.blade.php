...
@section('content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="cart-title">{{ __('Supplier List') }}</h4>
                    <div class="buttons">
                        <x-backend.admin.button :datas="[
                            'routeName' => 'sm.supplier.recycle-bin',
                            'label' => 'Recycle Bin',
                            'className' => 'btn-danger',
                            'permissions' => ['admin-restore'],
                        ]" />
                        <x-backend.admin.button :datas="[
                            'routeName' => 'sm.supplier.create',
                            'label' => 'Add New',
    ...
    {{-- Admin Details Modal  --}}
    <x-backend.admin.details-modal :datas="['modal_title' => 'Supplier Details']" />
@endsection
@push('js')
