...
<div class="grid grid-cols-1 md:grid-cols-3 gap-5">
    ...
    @foreach ($auctions as $auction)
        <div>
            <div class="bg-bg-white dark:bg-bg-dark-tertiary rounded-md shadow overflow-hidden min-h-96">
                <div class="p-4">
                    <div class="flex justify-between items-center">
                        <h3 class="text-lg font-semibold mb-0">{{ $auction?->title }}</h3>
                        <span class="px-2 py-1 text-text-white bg-bg-{{ $auction?->status=='2' ? 'wiz_green' : 'wiz_orange' }} rounded-full text-sm font-medium">
                ...
                <div class="p-4 space-y-3">
                    ...
                    <div class="flex justify-between items-center">
                        <p class="m-0 text-base">
                            ...
                            <span class="text-text-gray dark:text-text-light">{{ $auction?->product?->category?->name }}</span>
                        </p>
                    </div>
                    ...
                    <div class="flex justify-between items-center mt-3 text-base">
                        <p class="m-0">
                            ...
                            <span class="text-wiz_red font-medium">${{ number_format($auction?->start_price) }}</span>
                        </p>
                    ...
                    <div class="flex justify-between items-center mt-3">
                        <div class="flex items-center gap-2">
                            ...
                            <p class="text-wiz_red font-medium text-base m-0">${{ number_format($auction?->auctionBids?->last()?->bid_amount) }}</p>
                        </div>
